...
//var destinationDirectory = Argument("destinatifrankfaxonDirectory", @"<<the-deployment-folder>>");

///////////////////////////////////////////////////////////////////////
// ARGUMENTS (WITH DEFAULT PARAMETERS FOR LINUX (Ubuntu 16.04, Raspbian Jessie, etc)
///////////////////////////////////////////////////////////////////////
var runtime = Argument("runtime", "linux-arm");
var destinationIp = Argument("destinationPi", "192.168.1.20");
var destinationDirectory = Argument("destinationDirectory", @"/home/pi/iot/rasapi");
var username = Argument("username", "pi");
var sessionname = Argument("sessionname", "pi3docker");
var executableName = Argument("executableName", "rasapi");
